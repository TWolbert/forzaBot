...
module.exports = {
	...
	async execute(interaction) {
        try {
            // validate car getstring that is not a . or /
            if (interaction.options.getString('car').includes('.') || interaction.options.getString('car').includes('/')) return interaction.reply("Invalid car name", ephemeral = true)
